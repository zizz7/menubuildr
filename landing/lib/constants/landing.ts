...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    price: 'Free',
    period: '',
    features: ['1 restaurant', '1 menu template', 'Basic allergen tags', 'Single language'],
    recommended: false,
  ...
  },
  {
    ...
    price: '$29',
    period: '/month',
    features: ['Up to 5 restaurants', 'All menu templates', 'Full allergen management', 'Multi-language support', 'Priority support'],
    recommended: true,
    ctaLabel: 'Get Started',
    ctaHref: '/register',
  },
  {
    ...
    price: '$79',
    period: '/month',
    features: ['Unlimited restaurants', 'All menu templates', 'Full allergen management', 'Multi-language support', 'Dedicated support', 'Custom branding'],
    recommended: false,
    ctaLabel: 'Get Started',
    ctaHref: '/register',
  },
