...
export function RegisterForm() {
  ...
  const inputClass = "w-full py-[13px] px-4 bg-white border-[1.5px] border-[rgba(26,60,46,0.14)] rounded-[10px] font-[var(--font-dm-sans)] text-[0.9rem] text-[#1A3C2E] outline-none transition-all duration-200 placeholder:text-[rgba(139,115,85,0.45)] focus:border-[#E8A838] focus:shadow-[0_0_0_3px_rgba(232,168,56,0.13)]";
  ...
  return (
    <div className="w-full">
      ...
      <p className="text-[0.875rem] text-[#8B7355] mb-10 leading-relaxed">
        Start building beautiful menus today
      </p>

      <form onSubmit={(e) => handleSubmit(e, { name, email, password })}>
        {/* Name */}
        <div className="mb-5">
          <label htmlFor="name" className="block text-[0.8rem] font-medium text-[#1A3C2E] mb-[7px]">
            Name
          </label>
        ...
        {/* Email */}
        <div className="mb-5">
          <label htmlFor="email" className="block text-[0.8rem] font-medium text-[#1A3C2E] mb-[7px]">
            Email address
          </label>
        ...
        {/* Password */}
        <div className="mb-5">
          <label htmlFor="password" className="block text-[0.8rem] font-medium text-[#1A3C2E] mb-[7px]">
            Password
          </label>
          <div className="relative">
            <input id="password" type={showPassword ? 'text' : 'password'} autoComplete="new-password"
              placeholder="••••••••••" value={password} onChange={(e) => setPassword(e.target.value)}
              required disabled={loading} className={`${inputClass} pr-[46px]`} />
        ...
        {/* Confirm Password */}
        <div className="mb-5">
          <label htmlFor="confirm-password" className="block text-[0.8rem] font-medium text-[#1A3C2E] mb-[7px]">
            Confirm Password
          </label>
          <div className="relative">
      ...
      <p className="text-center mt-7 text-[0.85rem] text-[#8B7355]">
        ...
        <Link href="/login" className="text-[#1A3C2E] font-semibold no-underline border-b-[1.5px] border-[#E8A838] pb-[1px] hover:opacity-75 transition-opacity">
          Log in
        </Link>
      </p>
